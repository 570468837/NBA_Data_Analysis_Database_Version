	...
	class Refresh implements Runnable{
		...
		public void run() {
			...
			while(true){
				...
				refresh();
//				System.out.println("比赛场数："+SeasonListPO.getMatchesOfOneSeason(Season.season12_13).size());
//				System.out.println("第一个球员的比赛场数："+PlayerListPO.allPlayers.get(0).getMatches(Season.season12_13).size());
